...
<head>
	...
	require_once __DIR__ . '/../app/core/init.php';
	 ...
	 if(isset($_POST['signup'])) {
		...
		// Validatie
		if(!$terms) {
			echo "<script>alert('You must accept the terms!');</script>";
							...
							<div class="col-sm-10 col-xl-8 m-auto">
								...
								<form method="POST">
									...
									<div class="mb-4">
										...
										<div class="input-group input-group-lg">
											<span class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i class="fas fa-lock"></i></span>
											<input type="password" name="confirm_password" class="form-control border-0 bg-light rounded-end ps-1" placeholder="*********" id="inputPassword6">
										</div>
									</div>
									<!-- Check box -->
									<div class="mb-4">
										<div class="form-check">
											<input type="checkbox" name="terms" class="form-check-input" id="checkbox-1">
									...
									<div class="align-items-center mt-0">
										<div class="d-grid">
											<button type="submit" class="btn btn-primary mb-0" name="signup">Sign Up</button>
										</div>
									</div>
								</form>
								<!-- Form END -->
